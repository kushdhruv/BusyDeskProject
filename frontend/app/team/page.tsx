...
export default function TeamManagementPage() {
  ...
  return (
    <div className="p-6 max-w-6xl mx-auto space-y-6 animate-in fade-in duration-150">
      {/* Toast Notification */}
      {toastMessage && (
        <div className="fixed bottom-6 right-6 z-50 bg-slate-900 text-white text-xs px-4 py-3 rounded-lg shadow-xl flex items-center gap-2 animate-in slide-in-from-bottom-2">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-slate-200 pb-5">
        <div>
          ...
          <p className="text-xs text-slate-500 mt-1">
            Provision support agents, monitor live ticket workloads, and manage one-time onboarding credentials.
          </p>
        </div>

        <button
          onClick={() => setIsInviteOpen(true)}
          className="inline-flex items-center gap-2 px-3.5 py-2 text-xs font-semibold text-white bg-slate-900 hover:bg-slate-800 rounded-md transition-colors shadow-2xs cursor-pointer self-start sm:self-auto"
        >
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        ...
        <div className="p-4 bg-white rounded-lg border border-slate-200 shadow-2xs">
          ...
          <p className="text-2xl font-bold text-emerald-600 mt-1">{activeMembers}</p>
        </div>
        ...
        <div className="p-4 bg-white rounded-lg border border-slate-200 shadow-2xs">
          ...
          <p className="text-2xl font-bold text-amber-600 mt-1">{pendingInvitations}</p>
        </div>
        ...
        <div className="p-4 bg-white rounded-lg border border-slate-200 shadow-2xs">
          ...
          <p className="text-2xl font-bold text-slate-900 mt-1">{totalAssignedTickets}</p>
        </div>
      </div>
