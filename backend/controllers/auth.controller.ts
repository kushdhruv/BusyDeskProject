/**
 * Auth Controller
 * Manages user authentication, public customer registration, and internal agent directory lookup.
 */
...
export class AuthController {
  /**
   * Authenticates user credentials and returns session user payload.
   */
   ...
   * Security Invariant: Always enforces Role.CUSTOMER.
   */
  ...
  /**
   * Returns list of internal staff (Supervisors and Agents) for assignment.
   */
...
export const AuthService = AuthController;
