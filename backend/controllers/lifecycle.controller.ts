 ...
 * Enforces state machine validation rules and transition guards across ticket statuses.
 */
...
export class LifecycleController {
  /**
   * Validates whether a state transition is legal according to business and role rules.
   */
...
export const LifecycleService = LifecycleController;
